...
set "NEWRELICJAR=C:\NewRelic\newrelic.jar"
if not exist "%NEWRELICJAR%" goto noNewRelic
echo New Relic Java agent found at %NEWRELICJAR%
set NEWRELICSWITCH=-javaagent:"%NEWRELICJAR%"
:noNewRelic
...
set PR_DESCRIPTION=Apache Tomcat 7.0.50 Server - http://tomcat.apache.org/
set "PR_INSTALL=%EXECUTABLE%"
set "PR_LOGPATH=C:\SolrData\logs"
...
rem The following lines cause stdout and stderr to be logged to file
rem set PR_STDOUTPUT=auto
rem set PR_STDERROR=auto
"%EXECUTABLE%" //US//%SERVICE_NAME% ++JvmOptions "-Djava.io.tmpdir=%CATALINA_BASE%\temp;-Djava.util.logging.manager=org.apache.juli.ClassLoaderLogManager;-Djava.util.logging.config.file=%CATALINA_BASE%\conf\logging.properties;%NEWRELICSWITCH%" --JvmMs 128 --JvmMx 256
